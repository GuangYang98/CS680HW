...
public class AlphabeticalComparatorTest {
    ...
    public void AlphaOrderFileTest() {
        int i = 0;
        String[] expected = {"c","d"};
        LinkedList<ApfsFile> list = home.getFiles((ApfsElement f1, ApfsElement f2)-> f1.getName().compareTo(f2.getName()));
    ...
    public void AlphaOrderChildrenTest() {
        int i = 0;
        String[] expected = {"e","f"};
        LinkedList<ApfsElement> list = code.getChildren((ApfsElement f1, ApfsElement f2)-> f1.getName().compareTo(f2.getName()));
        String[] actual = new String[list.size()];
