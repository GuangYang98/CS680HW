...
public class TimeStampComparatorTest {
    ...
    @Test
    public void DateOrderFileTest() {
        int i = 0;
        String[] expected = {"c", "d"};
        LinkedList<ApfsFile> list = home.getFiles((ApfsElement f1, ApfsElement f2)-> {return f1.getCreationTime().compareTo(f2.getCreationTime());});
    ...
    @Test
    public void DateOrderChildrenTest() {
        int i = 0;
        String[] expected = {"e", "f"};
        LinkedList<ApfsElement> list = code.getChildren((ApfsElement f1, ApfsElement f2)-> {return f1.getCreationTime().compareTo(f2.getCreationTime());});
        String[] actual = new String[list.size()];
