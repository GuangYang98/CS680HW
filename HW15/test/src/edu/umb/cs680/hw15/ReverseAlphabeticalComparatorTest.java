...
public class ReverseAlphabeticalComparatorTest {
    ...
    public void AlphaOrderFileTest() {
        int i = 0;
        String[] expected = {"d", "c"};
        LinkedList<ApfsFile> list = home.getFiles((ApfsElement f1, ApfsElement f2)-> f2.getName().compareTo(f1.getName()));
    ...
    public void AlphaOrderChildrenTest() {
        int i = 0;
        String[] expected = {"f","e"};
        LinkedList<ApfsElement> list = code.getChildren((ApfsElement f1, ApfsElement f2)-> f2.getName().compareTo(f1.getName()));
        String[] actual = new String[list.size()];
